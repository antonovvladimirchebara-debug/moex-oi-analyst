Корень https://antonovvladimirchebara-debug.github.io/ отдаёт 404, поэтому Яндекс Вебмастер не находит метатег на «главной» хоста.
...
Блог по-прежнему открывается по /moex-oi-analyst/ — этот index только даёт 200 OK на корне и редирект.
